...
import Animasi from "./anim/scroll";

export default function Home() {
  const Prof = useRef<HTMLDivElement>(null);
  const About = useRef<HTMLDivElement>(null);
  const Contact = useRef<HTMLDivElement>(null);
  const Portofolio = useRef<HTMLDivElement>(null);
  ...
  const scrollToProf = () => {
    if (Prof.current) {
      Prof.current.scrollIntoView({ behavior: "smooth" });
    }
  };
  const scrollToAbout = () => {
    if (About.current) {
  ...
  return (
    <div role="page">
      <div className="top-0 sticky z-10">
        <div className="bg-zinc-900 h-[50px] w-screen">
          <div className="flex gap-5 justify-center">
            <button
              onClick={scrollToProf}
              className="rounded-2xl mt-[10px] w-[80px] h-[30px] bg-black text-lime-400 hover:cursor-pointer hover:bg-lime-400 hover:text-black"
            >
              Profile
            </button>
            <button
      ...
      <section role="CTA">
        <Animasi>
          <button
            onClick={scrollToPorto}
            className="bg-black text-lime-400 text-[25px] font-semibold hover:cursor-pointer hover:bg-lime-400 hover:text-black w-[200px] flex justify-center  max-sm:w-screen mt-[-50px] max-sm:mt-5 sm:mt-10 sm:w-screen md:w-[200px] md:ml-[37vw] md:mt-10 lg:ml-[120px] lg:mt-[-50px] xl:ml-[150px] rounded-xl"
          >
            View Portofolio
          </button>
        </Animasi>
            ...
            <div className="flex max-sm:flex-col sm:flex-col md:flex-col lg:flex-row gap-5">
              <Animasi>
                <p className="text-white w-[600px] max-sm:pr-2 max-sm:w-screen max-sm:text-justify sm:w-screen sm:text-justify sm:pr-2 md:w-screen lg:w-[500px] xl:w-[700px]">
                  I have always been fascinated by how websites work and how
                  they can create seamless user experiences. My interest in web
                  development grew as I explored HTML, CSS, JavaScript,
                  Typescript and Tailwind, experimenting with building
                  interactive web pages. Whether its front-end aesthetics or
                  back-end functionality, I strive for collaboration,
                  problem-solving, critical thinking, and adaptability to build
      ...
      <section role="Portofolio">
        <div className="mt-[100px] flex justify-center lg:justify-start lg:px-[50px]">
          <Animasi>
            <h3 ref={Portofolio} className="font-bold text-[50px] text-white">
              Portofolio
            </h3>
          </Animasi>
        </div>
            ...
            <div className="flex max-sm:flex-col sm:flex-col lg:flex-row gap-5">
              ...
              <div>
                ...
                <p className="text-white font-light mt-[25px] max-sm:text-justify sm:text-justify lg:text-left ">
                  A car showroom wants to have a website similar to the one
                  owned by BRABUS. The showroom requires an interactive website
                  with animations and a minimalist theme to showcase its
                  products effectively. The design, built using React on Next.js
                  along with Tailwind CSS, enhances interactivity, user
                  experience and ensures high performance for the website
                </p>
            ...
            <div className="flex max-sm:flex-col sm:flex-col lg:flex-row gap-5 mt-[50px]">
              ...
              <div>
                ...
                <p className="text-white font-light mt-[25px] max-sm:text-justify sm:text-justify lg:text-left ">
                  ...
                  important news, entertainment, and sports. They want the blog
                  to be easily accessible to everyone and simple to upload
                  specific information. The front-end design1 developed using
                  React on Next.js with TypeScript, incorporating Tailwind CSS
                  for styling. The blog is designed to ensure a great user
                  experience, high performance, efficient storage, and
          ...
          <Animasi>
            <div className="bg-zinc-900 max-sm:h-[600px] lg:h-[250px] p-5 rounded-xl">
              ...
              <p className="text-white text-[20px] font-light mt-[25px]">
                ● Recap all sales in Crispy Son (in Excel) ● Manage the
                inventory stock in Crispy Son (in Excel) ● Product Development
                in Crispy Son ● Design Planning in Crispy Son (in Adobe
                Photoshop) ● Manage Crispy Son employee’s skills ● Manage Crispy
                Son employee’s remuneration{" "}
              </p>
            </div>
          </Animasi>
          <Animasi>
            <div className="bg-zinc-900 max-sm:h-[600px] lg:h-[250px] p-5 rounded-xl mt-[20px]">
              ...
              <p className="text-white text-[20px] font-light mt-[25px]">
                ...
                Photoshop) ● Manage Indomie Cuan employees skills ● Manage
                Indomie Cuan employees remuneration
              </p>
            </div>
          </Animasi>
          <Animasi>
      ...
      <section ref={Contact} role="Contact" className="px-[50px] max-sm:px-0">
        <Animasi>
          <div className="flex justify-center mt-[50px]">
            <p className="text-white font-bold text-[30px]">CONTACT</p>
          </div>
          <div className="bg-zinc-900 h-[60px] max-sm:w-screen max-sm:gap-0 rounded-xl flex justify-center items-center gap-5">
            <Link
              href={
                "https://www.instagram.com/ananta___w?igsh=M2djaHNzNXd1cHRl&utm_source=qr"
              }
            >
              <FaInstagramSquare size={"50px"} className="text-pink-700" />
            </Link>
            <Link href={"//wa.me/<number>"}>
              <FaWhatsappSquare size={"50px"} className="text-lime-400" />
            </Link>
            <Link href={"https://discordapp.com/users/Altermis#3192"}>
              <FaDiscord size={"50px"} className="text-indigo-800" />
            </Link>
            <Link href={"https://github.com/Ananta116"}>
              <FaGithubSquare size={"50px"} className="text-white" />
            </Link>
          </div>
        </Animasi>
      </section>
